...
# enable_pmu, enable_dep_gen, enable_l0_swimlane) + 1024-byte NUL-terminated
...
def _read_config_from_mailbox(buf: memoryview) -> "CallConfig":
    ...
    block_dim, aicpu_tn, l2_swl, dt, pmu, dep_gen, l0_swl, prefix_bytes = _CFG_FMT.unpack_from(buf, _OFF_CONFIG)
    cfg = CallConfig()
    cfg.block_dim = block_dim
    cfg.aicpu_thread_num = aicpu_tn
    cfg.enable_l2_swimlane = l2_swl
    cfg.enable_dump_tensor = bool(dt)
    cfg.enable_pmu = pmu
    cfg.enable_dep_gen = bool(dep_gen)
    cfg.enable_l0_swimlane = l0_swl
