 ...
 * @brief Platform-specific configuration for a5 (Ascend 910B3/910C)
 */
...
/**
 * Maximum block dimension supported by a5 platform
 */
constexpr int PLATFORM_MAX_BLOCKDIM = 32;

/**
 * Maximum AICPU scheduling threads for a5 platform
 */
constexpr int PLATFORM_MAX_AICPU_THREADS = 8;

// =============================================================================
// Register Offsets (a5 architecture - DAV_3510)
// =============================================================================
...
/**
 * Fast path control register offset (not supported on a5)
 */
constexpr uint32_t REG_SPR_FAST_PATH_ENABLE_OFFSET = 0;

// =============================================================================
// Fast Path Control Values (not supported on a5)
// =============================================================================
