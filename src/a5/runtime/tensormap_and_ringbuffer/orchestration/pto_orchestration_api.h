...
#define _PTO2_CONCATENATE_IMPL(x, y) x##y                     // NOLINT(bugprone-reserved-identifier)
#define _PTO2_CONCATENATE(x, y) _PTO2_CONCATENATE_IMPL(x, y)  // NOLINT(bugprone-reserved-identifier)
