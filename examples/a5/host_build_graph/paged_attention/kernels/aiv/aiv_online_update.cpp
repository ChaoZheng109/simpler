...
#ifndef __gm__
#    define __gm__  // NOLINT(bugprone-reserved-identifier)
#endif

#ifndef __aicore__
#    define __aicore__ [aicore]  // NOLINT(bugprone-reserved-identifier)
#endif
...
// NOLINTEND(bugprone-easily-swappable-parameters)
    ...
    auto *mij_ptr = reinterpret_cast<float *>(mij_raw);
    auto *lij_ptr = reinterpret_cast<float *>(lij_raw);
    auto *oi_new_ptr = reinterpret_cast<float *>(oi_new_raw);
    auto *mi_ptr = reinterpret_cast<float *>(mi_raw);
    auto *li_ptr = reinterpret_cast<float *>(li_raw);
    auto *oi_ptr = reinterpret_cast<float *>(oi_raw);
    auto *dst_ptr = reinterpret_cast<float *>(dst_raw);
    ...
    constexpr int kDataBytes = M * N * static_cast<int>(sizeof(float));
    constexpr int kScalarNDBytes = kScalarRows * kScalarCols * static_cast<int>(sizeof(float));
    constexpr int kScalarDNBytes = kAlignedRows * static_cast<int>(sizeof(float));
...
extern "C" __aicore__ void kernel_entry(__gm__ int64_t *args) {
    auto *mij = reinterpret_cast<uint8_t *>(reinterpret_cast<uintptr_t>(args[0]));
    auto *lij = reinterpret_cast<uint8_t *>(reinterpret_cast<uintptr_t>(args[1]));
    auto *oi_new = reinterpret_cast<uint8_t *>(reinterpret_cast<uintptr_t>(args[2]));
    auto *mi = reinterpret_cast<uint8_t *>(reinterpret_cast<uintptr_t>(args[3]));
    auto *li = reinterpret_cast<uint8_t *>(reinterpret_cast<uintptr_t>(args[4]));
    auto *oi = reinterpret_cast<uint8_t *>(reinterpret_cast<uintptr_t>(args[5]));
    auto is_first = static_cast<int>(args[6]);
    auto is_last = static_cast<int>(args[7]);
    auto *dst = reinterpret_cast<uint8_t *>(reinterpret_cast<uintptr_t>(args[8]));
