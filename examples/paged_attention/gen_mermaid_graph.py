...
sys.path.insert(0, str(_script_dir / "kernels"))
from kernel_config import KERNELS

# Build mappings from kernel_config
FUNC_NAMES = {k["func_id"]: k["name"] for k in KERNELS}
CORE_TYPES = {k["func_id"]: k["core_type"].upper() for k in KERNELS}
